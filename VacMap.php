...
if(allOne){
  ...
  <body>
    <p>Date: <input type="text" id="datepicker"><input type="button" value="..." onclick="changeDate()"/></p>
    
    <div class="tab">
        <button class="tablinks" onclick="openTab(event, 'tab1')" id="defaultOpen"><?php echo $lang_arr['allArabCountries']; ?></button>
        <button class="tablinks" onclick="openTab(event, 'tab2')"><?php echo $lang_arr['eastArabCountries']; ?></button>
        <button class="tablinks" onclick="openTab(event, 'tab3')"><?php echo $lang_arr['westArabCountries']; ?></button>
    </div>
