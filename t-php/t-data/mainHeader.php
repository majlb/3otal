<?php
include ('t-php/t-data/IpInfo.php');
...
<div class="menu-toggle" id="menu-toggle">
	...
	<nav id="site-navigation" class="main-navigation">
		...
		<div class="menu-primary-menu-container"><ul id="menu-primary-menu" class="menu"><li id="menu-item-170" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-156 current_page_item menu-item-170"><a href="index.php?lang=<?php echo $lang?>" aria-current="page"><?php echo $lang_arr['HomePage']?></a></li>

<li id="menu-item-169" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-169"><a href="./t-php/t-menu/byMap.php?lang=<?php echo $lang?>"><?php echo $lang_arr['byMap']?></a></li>
...
<li id="menu-item-168" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-168"><a href="./t-php/t-menu/weekend.php?lang=<?php echo $lang?>"><?php echo $lang_arr['weekEnd']?></a></li>

<li id="menu-item-168" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-168"><a href="./t-php/t-menu/showCities.php?lang=<?php echo $lang?>"><?php echo $lang_arr['showCities']?></a></li>
		
<li id="menu-item-171" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-171"><a href="./t-php/t-menu/contactUs.php?lang=<?php echo $lang?>"><?php echo $lang_arr['contactUs']?></a></li>



<li id="menu-item-172" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-172"><a href="./t-php/t-menu/aboutUs.php?lang=<?php echo $lang?>"><?php echo $lang_arr['aboutUs']?></a></li>
